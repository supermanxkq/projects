...
public class GenericsUtils {
	 ...
	 * @param index
	 *            泛型参数�?��索引,�?�?��.
	 * @return 范型参数的实际类�? 如果没有实现ParameterizedType接口，即不支持泛型，�?��直接返回
	...
	/**
	 * 通过反射,获得方法输入参数第index个输入参数的�?��泛型参数的实际类�? �? public void add(Map<String,
	...
	/**
	 * 通过反射,获得方法输入参数第一个输入参数的�?��泛型参数的实际类�? �? public void add(Map<String, Buyer>
