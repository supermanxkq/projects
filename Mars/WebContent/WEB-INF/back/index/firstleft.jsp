			...
			function() {
				...
				$("#firstpane p.menu_head").click(
						function() {
							...
							}).next("div.menu_body").slideToggle(0).siblings(
...
<body>
	<div class="H_left">
		<div class="R_left_top">
			<div class="R_left_top_c">常用操作</div>
		</div>
		<div id="firstpane" class="menu_list">
			<%--		    <s:iterator value="#session.often" >--%>
			...
			<p class="menu_head">文章管理</p>
			<div class="menu_body">
				<a href="article/article!list?columnCode=1" target="main">文章管理 </a>
			</div>
		</div>
		<br />
	</div>
