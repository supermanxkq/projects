...
<body>
	<div class="Position">当前位置是：HOME &gt;&gt; 系统设置 &gt;&gt; 账号设置</div>
		...
		<s:form action="system/index!saveMyself" method="post" theme="simple">
			<table width="100%" border="0" cellpadding="0" cellspacing="0"
				...
				<tr>
					...
					<td align="left" width="30%"><s:property
							value="userDTO.userName" />
						<s:hidden name="userDTO.userName" /></td>
					<th align="right" width="20%">真实姓名：</th>
					<td align="left" width="30%"><s:textfield
							name="userDTO.realName" id="realName" maxlength="20"
				...
				<tr>
					...
					<s:if
						...
						<td align="left"><s:property
								value="#session.user_session.organName" /></td>
					</s:if>
					<s:elseif test="#session.user_session.userLevel==2">
						<th align="right">商户名称：</th>
						<td align="left"><s:property
								value="#session.user_session.merName" /></td>
					</s:elseif>
					<s:else>
						<th align="right"></th>
						<td align="left"></td>
				...
				<tr>
					...
					<td align="left"><s:textfield name="userDTO.teleNo"
							id="realName" maxlength="20" cssClass="formInput" /></td>
				...
				<tr>
					...
					<td align="left" colspan="3"><s:property
							value="userDTO.lastLoginTime" /></td>
				</tr>
				<tr>
					<td colspan="4"
						style="font-size: 14px; color: #000; font-weight: bold;"
				...
				<tr>
					...
					<td align="left" colspan="3"><input type="password"
						name="userDTO.passWord" id="passWord" maxlength="20"
						class="formInput" /></td>
				</tr>
				<tr>
					<th align="right">新密码：</th>
					<td align="left" colspan="3"><input type="password"
						name="userDTO.newPassWord" id="newPassWord" maxlength="20"
						class="formInput" /></td>
				</tr>
				<tr>
					<th align="right">重复新密码：</th>
					<td align="left" colspan="3"><input type="password"
						name="userDTO.confirmNewPassWord" id="confirmNewPassWord"
						maxlength="20" class="formInput" /></td>
				</tr>
			</table>
