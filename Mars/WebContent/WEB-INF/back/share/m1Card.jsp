...
<body>
	<input type="hidden" name="Version" id="Account" maxlength="100"
		size="20" />
	<input type="hidden" name="Serial" id="Account" maxlength="100"
		size="20" />
	<input type="hidden" name="DeviceHandle" id="Account" maxlength="100"
		size="5" value="-1" />
