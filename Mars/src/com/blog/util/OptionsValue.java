...
import com.blog.web.ui.OptionsInteger;
import com.blog.web.ui.OptionsString;
...
public class OptionsValue {
	...
	public static List<OptionsInteger> Advertma_SHOW = new ArrayList<OptionsInteger>();
	static {
		Advertma_SHOW.add(new OptionsInteger(1, "第一位置"));
		Advertma_SHOW.add(new OptionsInteger(2, "第二位置"));
		Advertma_SHOW.add(new OptionsInteger(3, "第三位置"));
		Advertma_SHOW.add(new OptionsInteger(4, "第四位置"));
		Advertma_SHOW.add(new OptionsInteger(5, "第五位置"));
		Advertma_SHOW.add(new OptionsInteger(6, "第六位置"));
	}
	public static List<OptionsInteger> advertContents = new ArrayList<OptionsInteger>();
	static {
		advertContents.add(new OptionsInteger(0, "商品广告"));
		advertContents.add(new OptionsInteger(1, "店铺广告"));
		advertContents.add(new OptionsInteger(2, "品牌广告"));
		advertContents.add(new OptionsInteger(3, "活动广告"));
	}
	...
	static {
		Advertma_location.add(new OptionsInteger(0, "主广告位"));	
	}
	...
	/** 启用状态 */
	public static List<OptionsInteger> STOCK_STATUS = new ArrayList<OptionsInteger>();
	static {
		STOCK_STATUS.add(new OptionsInteger(0, "90#汽油"));
		STOCK_STATUS.add(new OptionsInteger(1, "92#汽油"));
		STOCK_STATUS.add(new OptionsInteger(2, "93#汽油"));
		STOCK_STATUS.add(new OptionsInteger(3, "95#汽油"));
		STOCK_STATUS.add(new OptionsInteger(4, "97#汽油"));
		STOCK_STATUS.add(new OptionsInteger(5, "0#柴油"));
	}
	...
	/** 是否启用密码 */
	public static List<OptionsString> ADVERTMA_OPENTYPE = new ArrayList<OptionsString>();
	static {
		ADVERTMA_OPENTYPE.add(new OptionsString("0", "启用"));
		ADVERTMA_OPENTYPE.add(new OptionsString("1", "关闭"));
	}
	...
	/** 商户入驻申请状态 */
	public static List<OptionsInteger> MERSTOREAPPLY_STATUS = new ArrayList<OptionsInteger>();
	static {
		MERSTOREAPPLY_STATUS.add(new OptionsInteger(0, "待审核"));
		MERSTOREAPPLY_STATUS.add(new OptionsInteger(1, "审核通过"));
		MERSTOREAPPLY_STATUS.add(new OptionsInteger(2, "审核不通过"));
	}
	...
	/** 0：等待买家付款（WAIT_BUYER_PAY）；1：买家已付款，等待买家发货(WAIT_SELLER_SEND_GOODS)*/
	public static List<OptionsInteger> ORDER_STATUS = new ArrayList<OptionsInteger>();
	static {
		ORDER_STATUS.add(new OptionsInteger(0, "等待买家付款"));
		ORDER_STATUS.add(new OptionsInteger(1, "买家已付款，等待卖家发货"));
		ORDER_STATUS.add(new OptionsInteger(2, "卖家已发货，等待买家确认"));
		ORDER_STATUS.add(new OptionsInteger(3, "交易成功结束"));
		ORDER_STATUS.add(new OptionsInteger(4, "交易中途关闭（已结束，未成功完成）"));
	}

	/**
	 * 订单状态 0:代付款 1：待确定 2：订单确认 3：待发货 4：已发货 5：订单撤销 6：订单成功 7：订单失败 (8:退货中 9：退货成功 )
	 */
	public static List<OptionsInteger> ORDERS_STATUS = new ArrayList<OptionsInteger>();
	static {
		ORDERS_STATUS.add(new OptionsInteger(0, "待付款"));
		ORDERS_STATUS.add(new OptionsInteger(1, "待确定"));
		ORDERS_STATUS.add(new OptionsInteger(2, "订单确定"));
		ORDERS_STATUS.add(new OptionsInteger(3, "待发货"));
		ORDERS_STATUS.add(new OptionsInteger(4, "已发货"));
		ORDERS_STATUS.add(new OptionsInteger(5, "订单撤销"));
		ORDERS_STATUS.add(new OptionsInteger(6, "订单成功"));
		ORDERS_STATUS.add(new OptionsInteger(7, "订单失败"));
		ORDERS_STATUS.add(new OptionsInteger(8, "退款中"));
		ORDERS_STATUS.add(new OptionsInteger(9, "退货成功"));
	}

	/**
	 * 评价状态 0:未评价 1：已评价
	 */
	public static List<OptionsInteger> CRITICAL_STATUS = new ArrayList<OptionsInteger>();
	static {
		CRITICAL_STATUS.add(new OptionsInteger(0, "未评价"));
		CRITICAL_STATUS.add(new OptionsInteger(1, "已评价"));
	}

	/** （是否关闭 0 否 1 是） */
	public static List<OptionsInteger> ISCLOSE_STATUS = new ArrayList<OptionsInteger>();
	static {
		ISCLOSE_STATUS.add(new OptionsInteger(0, "否"));
		ISCLOSE_STATUS.add(new OptionsInteger(1, "是"));
	}
	...
	static {
		PEOPLE_TYPE.add(new OptionsInteger(0, "商城会员"));
	}
	 ...
	 * 评价类型
	 */
	public static List<OptionsInteger> APPTYPE = new ArrayList<OptionsInteger>() {
		private static final long serialVersionUID = 3443083539343211383L;

		{
			this.add(new OptionsInteger(0, "好评"));
			this.add(new OptionsInteger(1, "中评"));
			this.add(new OptionsInteger(2, "差评"));
		}
	};
	 ...
	 * 评论类型
	 */
	public static List<OptionsInteger> MCRTYPE = new ArrayList<OptionsInteger>() {
		private static final long serialVersionUID = 3443083539343211383L;
		{
			this.add(new OptionsInteger(1, "手工评论"));
			this.add(new OptionsInteger(2, "系统自动评论"));
		}
	};
	 ...
	 *会员等级
	 */
	public static List<OptionsString> MEM_GRADE = new ArrayList<OptionsString>();
	static {
		MEM_GRADE.add(new OptionsString("注册会员", "注册会员"));
		MEM_GRADE.add(new OptionsString("普通会员", "普通会员"));
		MEM_GRADE.add(new OptionsString("白银会员", "白银会员"));
		MEM_GRADE.add(new OptionsString("黄金会员", "黄金会员"));
		MEM_GRADE.add(new OptionsString("钻石会员", "钻石会员"));
	}

	/** 是否枚举 */
	public static List<OptionsInteger> ISEN_STATUS = new ArrayList<OptionsInteger>();
	static {
		ISEN_STATUS.add(new OptionsInteger(0, "是"));
		ISEN_STATUS.add(new OptionsInteger(1, "不是"));
		ISEN_STATUS.add(new OptionsInteger(2, "一半是"));
	}
	/**
	 * 投诉类型 0：对商品进行投诉 1：对商家进行投诉 :2：对商家服务进行投诉
	 */
	public static List<OptionsInteger> COMPLAINT_TYPE = new ArrayList<OptionsInteger>();
	static {
		COMPLAINT_TYPE.add(new OptionsInteger(0, "对商品进行投诉"));
		COMPLAINT_TYPE.add(new OptionsInteger(1, "对商家进行投诉 "));
		COMPLAINT_TYPE.add(new OptionsInteger(2, "对商家服务进行投诉 "));
	}
	/**
	 * 投诉状态 0 未投诉 1 投诉中 2 投诉完成
	 */
	public static List<OptionsInteger> ORDCOMPTYPE = new ArrayList<OptionsInteger>();
	static {
		ORDCOMPTYPE.add(new OptionsInteger(0, "未投诉"));
		ORDCOMPTYPE.add(new OptionsInteger(1, "投诉中 "));
		ORDCOMPTYPE.add(new OptionsInteger(2, "投诉完成 "));
	}
	/**
	 * 投诉状态 0：投诉退款申请等待平台确认中 1：平台不同意协议，等待买家修改 2: 平台将投诉交由卖家确认 3：投诉申请达成，已对卖家进行处罚
	 * 4：买家已退货，等待卖家确认收货 5：投诉关闭 6：投诉成功
	 * */
	public static List<OptionsInteger> ORDERCOMPSTA = new ArrayList<OptionsInteger>();
	static {
		ORDERCOMPSTA.add(new OptionsInteger(0, "投诉退款申请等待平台确认中"));
		ORDERCOMPSTA.add(new OptionsInteger(1, "平台将投诉交由卖家确认"));
		ORDERCOMPSTA.add(new OptionsInteger(2, "买家投诉不合理，投诉拒绝"));
		ORDERCOMPSTA.add(new OptionsInteger(3, "投诉申请达成，已对卖家进行处罚"));
		ORDERCOMPSTA.add(new OptionsInteger(4, "买家已退货，等待卖家确认收货"));
		ORDERCOMPSTA.add(new OptionsInteger(5, "投诉关闭"));
		ORDERCOMPSTA.add(new OptionsInteger(6, "投诉成功"));
		ORDERCOMPSTA.add(new OptionsInteger(7, "卖家已申诉"));
	}
	/***
	 * 平台投诉处理方式 1："平台不同意协议，等待买家修改" 2："投诉申请达成，已对卖家进行处罚" 3："投诉申请达成，对卖家进行处罚"
	 * 5："投诉关闭"
	 */
	public static List<OptionsInteger> ADMINORDERCOMPSTA = new ArrayList<OptionsInteger>();
	static {
		ADMINORDERCOMPSTA.add(new OptionsInteger(1, "平台将投诉交由卖家确认"));
		ADMINORDERCOMPSTA.add(new OptionsInteger(2, "买家投诉不合理，投诉拒绝"));
		ADMINORDERCOMPSTA.add(new OptionsInteger(3, "投诉申请达成，对卖家进行处罚"));
		ADMINORDERCOMPSTA.add(new OptionsInteger(5, "投诉关闭"));
	}
	/***
	 * 对店铺或商品的处理意见 1:进行警告 2:强制下架
	 */
	public static List<OptionsInteger> HANDLEWAY = new ArrayList<OptionsInteger>();
	static {
		HANDLEWAY.add(new OptionsInteger(1, "进行警告"));
		HANDLEWAY.add(new OptionsInteger(2, "强制下架"));
	}

	/** 站内信收信人0：全部会员1：全部商户 */
	public static List<OptionsInteger> RECEIVERS_FLAG = new ArrayList<OptionsInteger>();
	static {
		RECEIVERS_FLAG.add(new OptionsInteger(0, "全部会员"));
		RECEIVERS_FLAG.add(new OptionsInteger(1, "全部商户"));
	}
	/**
	 * 支付类型 快捷支付，网银，融芯宝
	 * **/
	public static List<OptionsInteger> CHARGERATETYPE = new ArrayList<OptionsInteger>();
	static {
		CHARGERATETYPE.add(new OptionsInteger(1, "融芯宝"));
		CHARGERATETYPE.add(new OptionsInteger(2, "快捷支付"));
		CHARGERATETYPE.add(new OptionsInteger(3, "网银费率"));
		CHARGERATETYPE.add(new OptionsInteger(4, "支付宝"));
		CHARGERATETYPE.add(new OptionsInteger(5, "第三方支付"));
	}
	/** 是否支持银行卡，1：支持，0：不支持 **/
	public static List<OptionsInteger> ISBANKCARD = new ArrayList<OptionsInteger>();
	static {
		ISBANKCARD.add(new OptionsInteger(1, "是"));
		ISBANKCARD.add(new OptionsInteger(0, "否"));

	}
	/**
	 * 商品状态  0、上架   1、下架
	 */
	public static List<OptionsInteger> GOODSALESTA = new ArrayList<OptionsInteger>();
	static{
		GOODSALESTA.add(new OptionsInteger(0, "上架"));
		GOODSALESTA.add(new OptionsInteger(1, "下架"));
	}
