...
public class BaseAction extends ActionSupport {
	...
	//	pageHTML.append("<font color=\"#000\">");
		pageHTML.append("<li><a href=\"#\">共<span class=\"page\">").append(pageView.getTotalrecord()).append("</span>条记录，第<span id=\"currPage\">")
			.append(pageView.getTotalpage() > 0 ? pageView.getCurrentpage() : 0).append("</span>/<span>").append(pageView.getTotalpage())
			.append("</span>页，每页").append(pageView.getMaxresult()).append("条</a></li>");
		if (pageView.getTotalpage() > 0) {

			if (pageView.getCurrentpage() == pageView.getPageindex().getStartindex()) {
				pageHTML.append("<li><a href=\"#\">[首页]</a></li>");
				pageHTML.append("<li><a href=\"#\">[上一页]</a></li>");
			} else {
				pageHTML.append("<li><a href=\"javascript:query('"+ pageView.getPageindex().getStartindex()+ "')\">[首页]</a></li>");
				int temp = pageView.getCurrentpage() - 1;
				pageHTML.append("<li><a href=\"javascript:query('" + temp + "')\">[上一页]</a></li>");
			}
			if (pageView.getCurrentpage() == pageView.getPageindex().getEndindex()) {
				pageHTML.append("<li><a href=\"#\">[下一页]</a></li>");
				pageHTML.append("<li><a href=\"#\">[尾页]</a></li>");
			} else {
				int temp = pageView.getCurrentpage() + 1;
				pageHTML.append("<li><a href=\"javascript:query('" + temp + "')\">[下一页]</a></li>");
				pageHTML.append("<li><a href=\"javascript:query('" + pageView.getPageindex().getEndindex() + "')\">[尾页]</a></li>");
			}
