			...
			<div class="col-md-12">
				...
				<div class="collapse navbar-collapse"
					...
					<ul class="nav navbar-nav">
						<li class="active"><a href="article/article">博客</a></li>
					...
					<div class="col-md-9">
						<div class="row ">
							<div class="col-md-12">
								...
								<ul class="list-inline text-right text-muted">
									<li><i class="glyphicon glyphicon-search"></i>阅读(${article.readTimes})</li>
									<li>
										<h6><fmt:formatDate pattern="yyyy-MM-dd HH:mm:ss"   value="${article.contentDate }" /></h6>
									<li>
										<h6>编辑：${article.author}</h6>
									</li>
								</ul>
								<hr />
