...
<script src="js/software/softwarestyle.js"></script>
<!-- 百度统计代码 -->
<script>
var _hmt = _hmt || [];
(function() {
...
function query(page) {
	...
	var typeId=$("#").val();
	var params = {
		"softWareDTO.typeId":typeId,
		"softWareDTO.name":name,
		"softWareDTO.page" : page
	};
	ajaxData("software/software!jsonPageList", params);
}
...
<body style="padding: 20px;" onload="query(${softWareDTO.page})">
			...
			<div class="col-md-12">
				...
				<div class="collapse navbar-collapse"
					...
					<ul class="nav navbar-nav">
						...
						<li class="active"><a href="software/software!list">软件库</a></li>
						<!-- 						<li><a href="#">留言板</a></li> -->
						<!-- <!-- 						<li><a href="#">商城</a></li> -->
						<!-- 						<li><a href="#">时间轴</a></li> -->
						<!-- 						<li><a href="#">音乐盒</a></li> -->
