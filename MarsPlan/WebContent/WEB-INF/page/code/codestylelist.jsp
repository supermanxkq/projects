...
<script type="text/javascript">
	...
	function query(page) {
		var params = {
			...
			"codeStyleDTO.page" : page
		};
		ajaxData("codestyle/codestyle!jsonPageListB", params);
	}
</script>
</head>
<body onload="query(${codeStyleDTO.page});">
	<div class="Position">当前位置是：代码库 &gt;&gt; 分类管理</div>
	<jsp:include page="/WEB-INF/page/share/common.jsp"></jsp:include>
	<s:hidden name="method" id="method" />
	<s:hidden name="codeStyleDTO.id" id="id" />
	<div class="search">
		<div class="Fl">
			<my:permission key="sy-1102-01" value="分类添加">
				<input type="button" class="formButton" value="添加"
					onclick="go('codestyle/codestyle!addUI')" />
			</my:permission>
		</div>
	</div>
