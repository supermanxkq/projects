...
<body>
	<div class="Position">
		当前位置是：HOME &gt;&gt; 系统设置 &gt;&gt; 账号设置
	</div>
	<div style="text-align: center;margin: 10px auto;">
	<s:form action="system/index!saveMyself" method="post" theme="simple">
	<table width="100%" border="0" cellpadding="0" cellspacing="0" class="formTable">
	      <tr>
	      	<td colspan="4" style="font-size: 14px;color: #000;font-weight: bold;" align="left">账号信息</td>
	      </tr>
	      <tr>
	      ...
	      <tr>
	        ...
	        <td align="left"><s:textfield name="userDTO.teleNo" id="realName" maxlength="20" cssClass="formInput"/></td>
