...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    function setContent(isAppendTo) {
		...
		function query(page) {
			...
			var params = {
				"memGroupsDTO.createTime" : createTime,
	...
	<jsp:include page="/WEB-INF/page/share/common.jsp"></jsp:include>
		...
		<table width="96%" id="listTable" class="listTable" cellpadding="0" cellspacing="0" >
			<tr>
				...
				全选</th>
				<th width="3%">序号</th>
				<th width="3%"><a name="groupId">群编号</a></th>
				<th width="10%"><a name="groupName">群组名称</a></th>
				<th width="10%"><a name="userName">创建人</a></th>
				<th width="10%"><a name="createTime" >创建时间</a></th>
				<th width="5%"><a name="groupCount" >群组人数</a></th>
				<th width="8%"><a name="status" >启用状态</a></th>
			</tr>
		</table>
