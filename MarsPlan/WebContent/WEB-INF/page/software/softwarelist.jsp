...
<script type="text/javascript">
	...
	function query(page) {
		...
		ajaxData("software/software!jsonPageListB", params);
	}
</script>
</head>
<body onload="query(${softWareDTO.page});">
	<div class="Position">当前位置是：软件库 &gt;&gt; 软件管理</div>
	<jsp:include page="/WEB-INF/page/share/common.jsp"></jsp:include>
	<s:hidden name="method" id="method" />
	<div class="search">
		<div class="Fl">
			<my:permission key="sy-2101-01" value="代码添加">
				<input type="button" class="formButton" value="添加"
					onclick="go('software/software!addUI')" />
			</my:permission>
		</div>
	</div>
