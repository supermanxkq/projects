...
<body>
	<div class="Position">
		当前位置是:<a href="managers/goods">软件库</a> &gt;&gt;分类管理
	</div>
	<jsp:include page="/WEB-INF/page/share/common.jsp"></jsp:include>
	<s:form action="softwarestyle/softwarestyle" method="post" theme="simple"
		onsubmit="return check();">
		<s:hidden name="method" id="method" />
		<s:hidden name="softWareStyle.id" id="id" />
		<table width="100%" border="0" cellpadding="0" cellspacing="0"
			...
			<tr>
				...
				<td style="text-align: left;"><s:textfield
						name="softWareStyle.name" id="name" maxlength="20"
