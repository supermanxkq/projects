...
// Node object
function Node(id, pid, name, htmlstr,url, title, target, icon, iconOpen, open) {
...
dTree.prototype.add = function(id, pid, name, htmlstr,url, title,  target, icon, iconOpen, open) {

	this.aNodes[this.aNodes.length] = new Node(id, pid, name, htmlstr,url, title, target, icon, iconOpen, open);
