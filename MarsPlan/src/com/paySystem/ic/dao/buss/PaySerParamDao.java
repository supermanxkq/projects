 ...
 * @Description:支付接口配置Dao
 * @date: 2014-7-10上午10:46:46
 * @author: 谢洪飞
 * @version: V1.0
 */
public interface PaySerParamDao extends DAO<PaySerParam> {
	...
	public static final String PAYSERPARAMDAO ="paySerParamDao";
