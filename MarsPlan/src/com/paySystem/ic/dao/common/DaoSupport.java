package com.paySystem.ic.dao.common;
...
public abstract class DaoSupport<T> implements DAO<T> {
	...
	/*** ----------------------------------基本方法-----------------------------------------***/
	/**
	 *@OverRiddenMethod：@see com.paySystem.ic.dao.common.DAO#save(java.lang.Object)
	 *@MethodName:save
	...
	/**
	 *@OverRiddenMethod：@see com.paySystem.ic.dao.common.DAO#saves(java.util.List)
	 *@MethodName:saves
	...
	/**
	 *@OverRiddenMethod：@see com.paySystem.ic.dao.common.DAO#update(java.lang.Object)
	 *@MethodName:update
	 *@Description:修改方法
	 *@param entity
	 *@Author:王楠
	...
	/**
	 *@OverRiddenMethod：@see com.paySystem.ic.dao.common.DAO#delete(java.io.Serializable[])
	 *@MethodName:delete
	 *@Description:删除方法
	...
	/**
	 *@OverRiddenMethod：@see com.paySystem.ic.dao.common.DAO#find(java.io.Serializable)
	 *@MethodName:find
	...
	/**
	 *@OverRiddenMethod：@see com.paySystem.ic.dao.common.DAO#findByJpl(java.lang.String)
	...
	/**
	 *@OverRiddenMethod：@see com.paySystem.ic.dao.common.DAO#getCount(java.lang.Object[], java.lang.String)
	 *@MethodName:getCount
	 *@Description:有参获取总条数的方法
	 *@param queryParams 查询参数
	 *@param wherejpql 查询语句
	 *@return
	 *@Author:王楠
	...
	*/
	...
	/**
	 *@OverRiddenMethod：@see com.paySystem.ic.dao.common.DAO#getScrollData(int, int)
	 *@MethodName:getScrollData
	 *@Description:获得分页信息
	 *@param firstindex  起始页
	 *@param maxresult 页中最大值
	 *@return
	 *@throws Exception
	 *@Author:王楠
	...
	public QueryResult<T> getScrollData(int firstindex, int maxresult,
		...
		// System.out.println("select o from "+ entityname + " o "
		// + (wherejpql == null || "".equals(wherejpql.trim()) ? "":
		// "where 1=1 " + wherejpql) + buildOrderby(orderby));
		setQueryParams(query, queryParams);
		/** 获取所有的记录 **/
