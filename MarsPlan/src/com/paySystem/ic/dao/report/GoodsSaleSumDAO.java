...
/**
 * @ProjectName:MCIU_DS
 * @ClassName:GoodsSaleSumDAO
 * @Description:商品销量汇总排名的DAO接口
 * @date: 2014-9-10
 * @author: 王楠
 * @version: V1.0
 */
public interface GoodsSaleSumDAO extends DAO<GoodsSaleSumDTO>{

	public static final String GOODSSALESUMDAO="goodsSaleSumDAO";
