...
public class GoodsAttributeFormatServiceImpl implements
		GoodsAttributeFormatService {
	 ...
	 */
	@Transactional(readOnly=false,propagation=Propagation.REQUIRED)
	public void saveForamt(GoodsFormatDTO formatDTO,
			GoodsFormatGroupRelaDTO formatGroupRelaDTO) {
	 ...
	 */
	@Transactional(readOnly=false,propagation=Propagation.REQUIRED)
	public void saveAssociation(Integer familyId,
	 ...
	 */
	public List<GoodsAttributeDTO> getAttributeByFamilyId(Integer familyId,String type)
			throws Exception {
	 ...
	 */
	public List<GoodsFormatDTO> getFormatByFamilyId(Integer familyId,String type)
			throws Exception {
