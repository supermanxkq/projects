...
public class SiteRemindInfoServiceImpl extends DaoSupport<SiteRemindInfo> implements SiteRemindInfoService{
	...
	/**
	 *@OverRiddenMethod：@see com.paySystem.ic.service.log.SiteRemindInfoService#find(java.lang.Integer)
	 *@MethodName:find
	 *@Description:通过id查询dto
	 *@param SiteRemindInfoId
	 *@return
	 *@Author:孙晓磊
	 *@Date:2014-9-15上午10:37:02
	 */
	public SiteRemindInfoDTO find(Integer SiteRemindInfoId) {
		SiteRemindInfoDTO siteRemindInfoDTO = siteRemindInfoDao.getSiteRemindInfoDTO(SiteRemindInfoId);
