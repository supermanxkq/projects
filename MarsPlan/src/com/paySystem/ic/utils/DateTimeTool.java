...
public class DateTimeTool {
	...
	/**
	 *@Title:getDiffDay
	 *@Description:判断yyyy-MM-dd HH:mm大小
	 *@param:@param beginDate 字符串类型开始日期
	 *@param:@param endDate 字符串类型结束日期
	 *@param:@return
	 *@return:Long 日期相差天数
	 ...
	 *@thorws:
	 */
	public static Long judgeDate(String beginDate, String endDate) {
	...
	public static String doDateFormatStringyymmddhhmmss(Date date) {
		SimpleDateFormat format = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
		String datetime = null;
		try {
			if (date == null) {
	...
	public static void main(String[] args) {
		System.out.println(DateTimeTool.isSameDay("yyyy-MM", new Date(),
				DateTimeTool.nDaysAgo(5, new Date())));
		System.out.println(DateTimeTool.dateFormat("", DateTimeTool.nDaysAgo(0,
				new Date())));
		System.out.println(DateTimeTool.dateFormat("yyyy-MM-dd", DateTimeTool
				.nMonthsAfter(3, new Date())));
		boolean flag = false;
		 ...
		 * 
		 * System.out.println(DateTimeTool.dateFormat("",
		 * DateTimeTool.nDaysAfter(3, new Date())));
