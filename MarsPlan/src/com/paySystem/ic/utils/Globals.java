...
public class Globals {
	...
	public static final String INDEX_DIR="D:\\lucene6";
//	public static final String INDEX_DIR="/usr/lucene";
	
	/** 每页显示记录数 */
	public static final int PAGE_NUM = 21;
	/**显示的索引的数量*/
	...
	public static final String TITLE = "徐半仙儿－火星计划";
	/** 初始化密码 */
