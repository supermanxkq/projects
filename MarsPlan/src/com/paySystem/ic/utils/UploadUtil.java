...
public class UploadUtil {
	...
	public static String uploadImg(File file, String fileName) throws Exception {
		...
		//String realPath = "/Users/neofans/Downloads/MarsPlan/images/";
//		String realPath = "/usr/images/";
	 ...
	 * @see 多文件上传
	 */
	public static String longRangeUpload(String urlstr, List<String[]> stringParams, List<File> files)
			throws Exception {
		String name = "";
		// 表单字段和文件的数据
	...
	public static File getURLImg(String imgurl) {
		...
		String saveFilePath = ServletActionContext.getServletContext().getRealPath("/") + "upload/images/" + filename
				+ "." + extensionName;
		try {
			// 实例化url
	...
	public static void main(String[] args) throws Exception {
		UploadUtil.uploadImg(new File("/Users/neofans/Downloads/S60302-182956.jpg"), "S60302-182956.jpg");
	}
