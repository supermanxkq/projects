		...
		$(document).ready(function(){
		 ...
		 function quit() {
			...
			function goHome() {
				...
				parent.main.location.href='<%=basePath%>collection/collection!list';
	 		}
	...
	<body >
		 <table height="100%" cellspacing="0" cellpadding="0" width="100%" border="0">
		  <tbody>
		    ...
		    <tr>
		      <td height="100%" style=" border-top:none; "><iframe style="z-index:-10;  width:100%; height:100%;" id="main" name="main"  allowTransparency="true" marginheight="0" src="<%=basePath%>collection/collection!list" frameborder="0" noResize></iframe></td>
		    </tr> 
		    <tr>
