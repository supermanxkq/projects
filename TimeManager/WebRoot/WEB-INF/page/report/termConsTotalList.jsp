	...
	<div class="search">
		<table class="searchTable" cellpadding="0" cellspacing="0">
		    <tr>
	            ...
	            <th>交易类型:</th>
				<td><s:select name="termConsTotalDTO.tradeType" id="tradeType" list="#request.flag" listKey="key" headerKey="-1" headerValue="全部" listValue="value" cssClass="formSelect" theme="simple" /></td>
	        </tr>
			<tr>
				<th>终端编号:</th>
