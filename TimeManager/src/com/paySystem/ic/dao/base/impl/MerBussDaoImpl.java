...
public class MerBussDaoImpl extends DaoSupport<MerBussParam> implements
		MerBussDao {
	...
	private MerBussParam getMerBussParam(MerchantsDTO merDto) {
		...
		MerBussParam merParam =
			this.find(merDto.getMerId())==null?new MerBussParam():this.find(merDto.getMerId());
