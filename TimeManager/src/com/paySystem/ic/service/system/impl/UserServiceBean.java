...
public class UserServiceBean extends DaoSupport<User> implements UserService {
	...
	public boolean exist(String username) {
		long count = (Long) em.createQuery(
				"select count(o) from User o where o.userName=?1")
	...
	public User validate(String username, String password) {
		List<User> list = em.createQuery(
				"from User o where o.userName=?1 and o.passWord=?2")
				.setParameter(1, username).setParameter(2,
						MD5.MD5Encode(password)).getResultList();
	...
	public UserSession getUserSession(User user,
		...
		userSession.setDlsFlag(user.getDlsFlag());// 代理商标志
	...
	public List<OptionsString> getDlsOption() {
		List<User> organsList = em.createQuery(
				"from User o where o.dlsFlag = 1 order by userName asc")
				.getResultList();
	...
	public List<OptionsString> getDlsOptionByOrganId(String organId) {
		List<User> organsList = em.createQuery(
				"from User o where o.dlsFlag = 1 and o.organId = '" + organId
						+ "' order by userName asc").getResultList();
