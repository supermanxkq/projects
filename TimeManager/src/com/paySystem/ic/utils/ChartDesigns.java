...
/**
 * @ClassName:ChartDesigns
 * @Description:FusionChart封装工具类
 * @date: 2014-3-7下午01:46:08
 * @author: 谢洪飞
 * @version: V1.0
 */
public class ChartDesigns {
	/**
	...
	private static final String JSPATH = "js/fusioncharts/FusionCharts.js";

	private static final String SWFPATH = "js/fusioncharts/fusioncswf/";// fusionChart swf文件路径

	// user-defind
	private String caption; // 图形报表的标题名称

	private String xAxisName;// 横向坐标轴(x轴)名称

	private String yAxisName;// 纵向坐标轴(y轴)名称

	private Integer width;// x轴宽

	private Integer height;// y轴宽

	private String jsPath;// js Fusioncharts路径

	private String swfPath;// swf文件存放路径
	 ...
	 *            一维数据
	 */
	public ChartDesigns(String caption, String xAxisName, String yAxisName,
	...
	/**
	 * 该构造方法是为多维数据写的： List<String>含义是x轴的名称, Map<Object, Map<Object,
	 * Object>>含义是每一维所对应的值的集合. 例子:List<String> = {"一月","二月","三月","四月","五月"}
	 * Map<Map<Object, Map<Object, Object>>> = {
	 * {2013年,{{"一月",100},{"二月",200},{"三月",300}...}},
	 * {2014年,{{"一月",100},{"二月",200},{"三月",300}...}}... }
	 * 
	 * @param caption
	 * @param xAxisName
	 * @param yAxisName
