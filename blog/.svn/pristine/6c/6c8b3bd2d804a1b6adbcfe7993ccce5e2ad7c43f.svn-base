					...
					<div class="row-fluid">
						<div class="span12">
							...
							<ul class="breadcrumb">
								...
								<li>
									<a href="javascript:void(0);">新建资源</a><span class="divider-last">&nbsp;</span>
								</li>
							</ul>
							...
							<div class="widget">
								...
								<div class="widget-body">
									<s:form action="article/article" method="post" id="fm"
										...
										<input name="articleDTO.user.userId"
											value="${user_session.userId}" type="hidden" />
										<input name="articleDTO.articleId"
											value="${articleDTO.articleId}" type="hidden" />
										<table width="100%" border="0" cellpadding="0" cellspacing="0"
											...
											<tr>
												...
												<td>
													<s:textfield name="articleDTO.title" id="name"
											...
											<tr>
												<td align="right">
													<span class="Color5">* </span>分类：
												</td>
												<td>
													<s:select list="#request.blogTypes" listKey="key"
														listValue="value" name="articleDTO.blogType.blogTypeId"></s:select>
												</td>
												<th align="right">
