...
<body text=#000000 bgColor="#ffffff" leftMargin=0 topMargin=4>
	<div id="main">
        ...
        <form name=alipayment action="help/help!createHelp" method=post target="_blank">
            <div id="body" style="clear:left">
                <dl class="content">
					...
					<dd>
						...
						<input size="30" name="orderDTO.price" />
						<span>必填
</span>
					</dd>
<%--					<dt>订单描述--%>
...
<%--					<dd>--%>
<%--						<span class="null-star">*</span>--%>
<%--						<input size="30" name="orderDTO.body" />--%>
<%--						<span></span>--%>
<%--					</dd>--%>
<%--					<dt>商品展示地址：</dt>--%>
<%--					<dd>--%>
<%--						<span class="null-star">*</span>--%>
<%--						<input size="30" name="orderDTO.show_url" />--%>
...
<%--					<dd>--%>
<%--						<span class="null-star">*</span>--%>
<%--						<input size="30" name="orderDTO.receive_name" />--%>
<%--						<span>如：张三--%>
<%--</span>--%>
<%--					</dd>--%>
<%--					<dt>收货人地址：</dt>--%>
<%--					<dd>--%>
<%--						<span class="null-star">*</span>--%>
<%--						<input size="30" name="orderDTO.receive_address" />--%>
...
<%--					<dd>--%>
<%--						<span class="null-star">*</span>--%>
<%--						<input size="30" name="orderDTO.receive_zip" />--%>
<%--						<span>如：123456--%>
<%--</span>--%>
<%--					</dd>--%>
<%--					<dt>收货人电话号码：</dt>--%>
<%--					<dd>--%>
<%--						<span class="null-star">*</span>--%>
<%--						<input size="30" name="orderDTO.receive_phone" />--%>
...
<%--					<dd>--%>
<%--						<span class="null-star">*</span>--%>
<%--						<input size="30" name="orderDTO.receive_mobile" />--%>
