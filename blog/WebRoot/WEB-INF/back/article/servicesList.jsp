	...
	<body onload="query(${articleDTO.page})">
		...
		<div class="search">
			...
			<table class="searchTable" cellpadding="0" cellspacing="0">
				<tr>
					...
					<td>
						<s:textfield name="articleDTO.title" id="title"
					...
					<td>
						<s:textfield id="guest" name="articleDTO.guest"
							cssClass="formInput" theme="simple" maxlength="20"/>
					</td>
					<td>
		...
		<table width="96%" id="listTable" class="listTable" cellpadding="0"
			...
			<tr>
				...
				<th width="8%">
					<a name="actionDate" class="sort">活动时间</a>
				</th>
				<th width="8%">
					<a name="contentDate" class="sort">发表时间</a>
				</th>
				<th width="8%">
					编辑者
				</th>
