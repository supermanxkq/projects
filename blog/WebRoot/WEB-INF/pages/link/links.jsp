...
<html lang="en">
	 ...
	 */
	function ajaxQuery() {
		var dataUrl = "link/link!jsonPageList";
		var params = null;
		$.ajax( {
			url : dataUrl,
			data : params,
	...
	<!-- END HEAD -->
	<!-- BEGIN BODY -->
	<body class="fixed-top" onload="ajaxQuery()">
		 <!-- Begin header -->
				...
				<ul class="sidebar-menu">
					...
					<a href="javascript:;" class=""> <span class="icon-box"><i
						...
						<ul  class="sub">
							...
							<li>
								<a class="" href="link/link!toEditPage?columnCode=2">好456管理</a>
							</li>
							</s:if>
						</ul>
					</li>
						...
						<div class="span12">
							<div class="widget" style="height:700px;">
								...
								<div class="widget-body">
									<div class="row-fluid">
										<div class="span12" id="tabContent">
											<!--BEGIN TABS-->
