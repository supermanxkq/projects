...
public class Utils {
	 ...
	 * @param object
	 */
	public static String printInfo2(Object object) {
		HttpServletResponse response = ServletActionContext.getResponse();
//		注册Gson类型
//		 Gson gson=new GsonBuilder().registerTypeAdapter(QueryResult.class, new JsonSerializer<QueryResult>() {
//			 			public JsonElement serialize(QueryResult commentsDTO, Type typeOfSrc,
//			                    JsonSerializationContext context) {
//			                JsonObject o=new JsonObject();
//			                o.addProperty("content", commentsDTO.getResultlist());
//			               //o.addProperty("name", src.getName());
//			                 return o;
//			             }
//			       }).create();
		String result = new GsonBuilder().excludeFieldsWithoutExposeAnnotation().create().toJson(object);
//		String result = gson.toJson(object);
		response.setContentType("text/json; charset=utf-8");
		response.setHeader("Cache-Control", "no-cache"); // 取消浏览器缓存
		PrintWriter out = null;
