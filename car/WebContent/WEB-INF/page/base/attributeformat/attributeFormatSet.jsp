       ...
       $(document).ready(function(){
		...
		function addFormatAndGroup(groupId,type){
		    ...
		    trHtml+="    <td><div id=\""+rowId+"CON\"></div></td>";
		   	trHtml+="</tr>";
			$("#attributeFormatTb tbody>tr:last").after(trHtml); 
			groupIndex++;
			return rowId;
		}
			...
			<div style="display:block;width:96%;padding-top:15px;padding-left:10px;">
				...
				<fieldset style="margin-top:20px;display:none" id="addAttContal">
					...
					<div style="display:block;margin:10px 20px;line-height:28px;overflow:hidden;">
						<div style="display:inline;float:left;padding-right:10px">属性名称：<input type="text" cssClass="formInput" name="attrName" id="attrName" maxlength="30"  onblur="checkAttributeName()"></div>
						<div style="display:inline;float:left;padding-right:20px">是否为枚举：
							<select name="isEn" id="isEn">
						...
						<div style="display:inline"><input type="button" class="formButton" value="确定补充" onclick="saveAttribute()"></div>
					</div>
				</fieldset>
			</div>
		</div>
