	  ...
	  function settPeriodBlur(obj){
		...
		var check = function() {
          ...
          //  settlementWayFlag = showErrorMsg(setmentWay,type,settWayErrorMsg,"settWayErrorMsg","settWayWarnMsg");
            ...
            //alert("merNameFlag  "+merNameFlag);
           // alert("conPerNameFlag   "+conPerNameFlag);
           // alert("conPerTeleNoFlag   "+conPerTeleNoFlag);
           // alert("teleNoFlag   "+teleNoFlag);
           // alert("settlementPeriodFlag    "+settlementPeriodFlag);
            //alert("organIdFlag   "+organIdFlag);
           // alert("coopWayFlag  "+coopWayFlag);
         
		    if(!(merNameFlag&&conPerNameFlag
                   &&conPerTeleNoFlag&&teleNoFlag
                   &&settlementPeriodFlag&&organIdFlag
                   &&coopWayFlag)){
                  alert("商户基本信息   填写信息有误，*号信息为必填项!");
                  return false;
               }	
            if(!gnoPrefixFlag){
                    alert("商户业务参数   填写信息有误，*号信息为必填项!");
                    return false;
                }	
	...
	<s:if test="#session.user_session.userLevel!=2">
		<table width="100%" border="0" cellpadding="0" cellspacing="0" class="formTable">
			...
			<tr>
		        ...
		        <td><s:textfield name="merchantsDTO.settPeriod" id="settPeriod" maxlength="3" onkeyup= "replaceToNum(this);"  onkeypress="return onlyNum(this);" onblur="settPeriodBlur(this);" cssClass="formInput" cssStyle="width: 50px;"/> 天 <label id="settPriodErrorMsg" style="display: none;"></label></td>
		      	<th align="right">上次结算时间：</th>
		        <td><s:date format="yyyy-MM-dd HH:mm:ss"  name="merchantsDTO.lastSettTime"/></td>
			</tr>
		  	<tr>
		      	<th align="right">开户银行：</th>
		        <td><s:textfield name="merchantsDTO.bankName" id="bankName" maxlength="20" cssClass="formInput"/></td>
		        <th align="right">开户账号：</th>
		        <td><s:textfield name="merchantsDTO.bankAccountNo" id="bankAccountNo" maxlength="40" cssClass="formInput"/></td>
		   	</tr>
		  	<tr>
		      	<th align="right">开户名称：</th>
		        <td><s:textfield name="merchantsDTO.bankUser" id="bankUser" maxlength="20" cssClass="formInput"/></td>
		...
		<table width="100%" border="0" cellpadding="0" cellspacing="0" class="formTable">
			...
			<tr>
		 	...
		 	<tr>
		        ...
		        <td><s:textfield name="merchantsDTO.countryCode" id="countryCode" maxlength="8" cssClass="formInput"/></td>
		   	</tr>
		   	<tr>
		      	<th align="right">所在地区：</th>
		        <td>
			...
			<tr>
		      	<th align="right"><span class="Color5">* </span>结算周期：</th>
		        <td><s:property value="merchantsDTO.settPeriod"/> 天</td><s:hidden id="settPeriod" value="merchantsDTO.settPeriod"></s:hidden>
		      	<th align="right">上次结算时间：</th>
		        <td><s:date format="yyyy-MM-dd HH:mm:ss" name="merchantsDTO.lastSettTime"/></td>
			</tr>
		  	<tr>
