...
<body onload="query(${merchantsDTO.page });">
	<div class="Position">当前位置是：HOME &gt;&gt; 基本信息 &gt;&gt; 商户管理</div>
	...
	<div class="search">
		<div class="Fl">
			<my:permission key='sy-1201-02' value='商户添加'>
				<input type="button" class="formButton" value="添加"
					onclick="go('base/merchants!addUI')" />
			</my:permission>
		</div>
		<table class="searchTable" cellpadding="0" cellspacing="0">
			<tr>
				...
				<td>商户编号:</td>
				<td><s:textfield id="merId" name="merchantsDTO.merId"
						cssClass="formInput" maxlength="20" theme="simple" /></td>
				<td>商户名称:</td>
				<td><s:textfield id="merName" name="merchantsDTO.merName"
						cssClass="formInput" maxlength="20" theme="simple" /></td>
				<td>启用状态:</td>
				<td><s:select name="merchantsDTO.status" id="status"
