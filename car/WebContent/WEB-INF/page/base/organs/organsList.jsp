	...
	<div class="search">
		<table class="searchTable" cellpadding="0" cellspacing="0">
			<tr>
			    ...
			    <td>机构编号:</td>
				<td><s:textfield id="organId" name="organsDTO.organId" cssClass="formInput" maxlength="20" theme="simple"/></td>
				<td>机构名称:</td>
				<td><s:textfield id="name" name="organsDTO.name" cssClass="formInput" maxlength="20" theme="simple"/></td>
	...
	<div class="listBottom">
		<div class="Fl">
			<my:permission key='sy-1101-02' value='发卡机构添加'>
				<input type="button" class="formButton" value="添加" onclick="go('base/organs!addUI')"/>
			</my:permission>
		</div>
