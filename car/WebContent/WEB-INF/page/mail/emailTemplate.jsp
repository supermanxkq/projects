...
<body onload="">
	...
	<table width="96%"  cellpadding="0" cellspacing="0" class="formTable" >
		...
		<tr>
		  ...
		  <td><s:textfield id="emailTile" name="emailTemplateDTO.emailTile" size="32"></s:textfield></td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td>
			  <s:textarea name="emailTemplateDTO.etContent" id="etContent" cols="50" rows="9"></s:textarea>
			</td>
		</tr>
	</table>
	<div>
