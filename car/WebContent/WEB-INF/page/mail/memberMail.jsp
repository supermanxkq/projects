...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    function setContent(isAppendTo) {
		...
		function sendMail(){
			...
			var actionUrl = "mail/mail!sendMail"; 
			var params={
				"emailStr":emailStr,
...
<body onload="query(${memberDTO.page });">
	...
	<jsp:include page="/WEB-INF/page/share/common.jsp"></jsp:include>
		...
		<div id="dialog-confirm" style="display: none;text-align: center;width: 1024px;" title="编辑邮件内容" >
				<table width="100%" border="0" bordercolor="#000000" cellpadding="0" cellspacing="0"
					class="formTable"  >
					<tr>
						<th  style="text-align: center; width: 10%;">
								<label for="tags" >收件人: </label>
		...
		<div class="search">
			<table class="searchTable" cellpadding="0" cellspacing="0">
				<tr>
					...
					<td>创建日期:</td>
					<td>
						<td><s:textfield id="createTimee" name="termConsDto.beginDate" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd'})" cssStyle="width:150px;" maxlength="20" theme="simple" readonly="true" /></td>
					</td>
		        	<td>会员状态:</td>
					<td>
						<s:select  id="statuss" list="#request.status" headerKey="-1" headerValue="请选择" listKey="key" listValue="value" cssClass="formSelect" theme="simple"/>
					</td>
		...
		<table width="96%" id="listTable" class="listTable" cellpadding="0" cellspacing="0" >
			<tr>
				...
				全选</th>
				<th width="3%">序号</th>
				<th width="10%"><a name="memId">会员编号</a></th>
				<th width="10%"><a name="memRealName">会员姓名</a></th>
				<th width="10%"><a name="createTime" >创建时间</a></th>
				<th width="5%"><a name="sex" >会员性别</a></th>
				<th width="8%"><a name="status" >会员状态</a></th>
			</tr>
		</table>
		<div class="listBottom">
			<div class="Fl">
				<s:if test="#session.user_session.userLevel!=2">
					<input type="button" class="formButton" value="发送邮件" onclick="editContent();"/>
				</s:if>
			</div>
