	...
	<script type="text/javascript">
	    ...
	    var loadBeginCardNo = function () {
             ...
             if(cardBinNo == "-1"){
                 ...
                 $.ajax({
                 url:"stock/orgcard!loadBeginCardNo",
                 type:"POST",
                 data:"modStockDTO.cardBinNo="+cardBinNo+"&modStockDTO.organId="+organId, 
                 dataType:"json",
                 success:function(data){                         
                      var cardNo = data;
...
<body>
	<div class="Position">
		当前位置是：HOME &gt;&gt; 库存管理 &gt;&gt; 机构领卡
	</div>
	<jsp:include page="/WEB-INF/page/base/organs/organHelp.jsp"></jsp:include>
	<s:form action="stock/orgcard" method="post" onsubmit="document.getElementById('submitInput').disabled = true;return true;" theme="simple">
	<s:hidden name="method"/>
	<s:if test="#session.user_session.userLevel==0">
		<table width="100%" border="0" cellpadding="0" cellspacing="0" class="formTable">
			<tr>
			    <th align="right" width="20%"><span class="Color5">* </span>领卡机构：</th>
