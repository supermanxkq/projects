...
public class AnnountServiceImpl extends DaoSupport<Annount> implements AnnountService {
	
	@Resource
	private AnnountDAO annountDao;

	/**
	 *@OverRiddenMethod：@see com.paySystem.ic.service.marketing.AnnountService#queryResult(int, int, com.paySystem.ic.web.dto.marketing.AnnountDTO, java.util.LinkedHashMap)
	 *@MethodName:queryResult
	 *@Description:查询方法
	 *@param page 当前页
	 *@param pageNum 每页显示的条数
	 *@param annountDTO 全站公告管理	DTO
	 *@param orderby 条件
	 *@return
	 *@throws Exception
	 *@Author:孙晓磊
	...
	/**
	 *@OverRiddenMethod：@see com.paySystem.ic.service.marketing.AnnountService#addSaveAnnount(com.paySystem.ic.web.dto.marketing.AnnountDTO)
	 *@MethodName:addSaveAnnount 
	 *@Description:保存方法
	 *@param annountDTO 全站公告管理DTO
	 *@Author:孙晓磊
	...
	/**
	 *@OverRiddenMethod：@see com.paySystem.ic.service.marketing.AnnountService#findAnnounTitle(java.lang.String, java.lang.String, java.lang.Integer)
	 *@MethodName:findAnnounTitle
	 *@Description:查询方法
	 *@param announTitle 公告标题
	 *@param method 方法名称
	 *@param announTitleId 公告ID
	 *@return
	 *@Author:孙晓磊
	...
	public boolean findAnnounTitle(String announTitle, String method,
		...
		else
		{
			...
			if (list.size() > 0 && !list.get(0).getAnnounId().equals(announTitleId)) {
				flag = true;
			}
		}
		return flag;
	...
	/**
	 *@OverRiddenMethod：@see com.paySystem.ic.service.marketing.AnnountService#find(java.lang.Integer)
	 *@MethodName:find
	 *@Description:查询方法
	 *@param annountId 公告ID
	 *@return
	 *@Author:孙晓磊
	...
	/**
	 *@OverRiddenMethod：@see com.paySystem.ic.service.marketing.AnnountService#updateAnnount(com.paySystem.ic.web.dto.marketing.AnnountDTO)
	 *@MethodName:updateAnnount
	 *@Description:修改方法
	 *@param annount 公告的DTO
	 *@Author:孙晓磊 
