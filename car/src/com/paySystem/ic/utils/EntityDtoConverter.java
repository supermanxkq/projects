...
import com.paySystem.ic.utils.annotation.RefBean;
import com.paySystem.ic.web.dto.base.MerchantsDTO;

/**
 * Bean与DTO转换工具类
 * @ClassName:EntityDtoConverter
 * @Description:Bean与DTO转换工具类
 * @date: 2014-7-23上午09:12:52
 * @author: 谢洪飞
 * @version: V1.0
 */
 ...
 * @throws NoSuchMethodException 
                                         ...
                                         InstantiationException, NoSuchMethodException
 {
    ...
    /*	mDto.setOrganId("222222222");
    	mDto.setMerId("999999");
    	mDto.setMerName("测试商户信息");*/
    	
    	
    	organs.setOrganId("1111111");
    	
    	m.setOrgans(organs);
    	m.setMerId("000000000001");
    	
    	
    	mDto = (MerchantsDTO) bean2Dto(m,mDto);
    	
    	/*mDto = (MerchantsDTO) bean2Dto(m,mDto);*/
    	
    	System.out.println(mDto.getOrganId());
    	
    	System.out.println(mDto.getMerId());
    	
    	System.out.println(mDto.getMerName());
    }
