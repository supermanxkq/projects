			...
			<tr>
		        ...
		        <td width="30%">
					...
					<s:if test="method=='checkUI'">
					     <span id="upimg"  style="color:gray"> <img height="30px" width="50px" id="imgs1" /></span>
					</s:if>
					<s:elseif test="method=='editSave'">
					  <s:file id="file" name="image" size="40" onChange="checkfile1();"  ></s:file>
					  <span id="upimg" style="color:gray"> <img height="30px" width="50px"  id="imgs" />已上传图片!如需修改请选择</span>
