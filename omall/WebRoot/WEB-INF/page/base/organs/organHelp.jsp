		...
		<div >
			<table class="searchTable" cellpadding="0" cellspacing="0">
				<tr>
		            <td></td>
		            <td>机构编号:</td>
					<td><input type="text" id="orgId" name="organsDTO.organId" onkeyup = "allowEnCnNu(this)" maxlength="20" class="formInput"/></td>
					<td>机构名称:</td>
					<td><input type="text" id="orgname" name="organsDT.name" maxlength="30" class="formInput"/></td>
