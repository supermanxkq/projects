...
<body>
	<div class="Position">
		当前位置是：HOME &gt;&gt; 基本信息 &gt;&gt; 发卡机构管理 <s:property value="organsDTO.yearServSign"/>
	</div>
	...
	<s:if test="#session.user_session.userLevel==0">
		<table width="100%" border="0" cellpadding="0" cellspacing="0" class="formTable">
			<tr>
		 	...
		 	<tr>
		  	...
		  	<tr>
		        ...
		        <td><s:textfield name="organsDTO.teleNo" onfocus = "teleNoFocus(this);" onblur="teleNoBlur(this);" onkeyup = "replaceToNum(this);" id="teleNo" maxlength="11" cssClass="formInput" theme="simple"/><label id="teleNoErrorMsg" style="display: none;"></label> <label id="teleNoWarnMsg" style="display: none;"></label></td>
			...
			<tr>
		        ...
		        <td colspan="3"><s:textarea name="organsDTO.emContPhone" id="emergConTel"  onkeyup="validatelength(this);"   cssClass="formTextarea" cols="80" rows="5"/><span class="Color3">填3-5个，以","号隔开</span></td>
		  	</tr>
		   	<tr>
		      	<th align="right">机构描述：</th>
		        <td colspan="3"><s:textarea name="organsDTO.orgDesc" id="description" onkeyup="validatelength1(this);" cssClass="formTextarea" cols="80" rows="5" /></td>
		   	</tr>
		</table>
	</s:if>
			...
			<tr>
		 	...
		 	<tr>
		  	...
		  	<th align="right">紧急联系人电话：</th>
		   	...
		   	<tr>
		      	<th align="right">机构描述：</th>
		        <td colspan="3"><s:textarea name="organsDTO.orgDesc" id="description" onkeyup="validatelength1(this);"  cssClass="formTextarea" cols="45" rows="5" /></td>
		   	</tr>
		</table>
	</s:if>
