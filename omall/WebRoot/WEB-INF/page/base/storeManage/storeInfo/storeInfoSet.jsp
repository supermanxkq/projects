...
<html>
  ...
  function getContentValue(){
	...
	function check(){
		...
		if(goodsFamilyFlag&&storeNameFlag&&getContentValueFlag&&contPersonFlag&&teleNoFlag&&storeAddressFlag&&licenseFlag&&storeIntroductFlag&&fileValueMsg){
			return true;
			}else{
				alert("页面信息填写有误!");
			return false;
...
.clear {
	...
	<body onload="setEditorStatus();">
		...
		<s:form action="base/storeInfo" method="post"
			...
			<s:hidden name="type" value="noTab" />
			...
			<table width="100%" border="0" cellpadding="0" cellspacing="0"
				...
				<tr>
					...
					<td>
						<s:select id="Fname" name="storeInfoDTO.provinceId"
							...
							headerKey="110000" headerValue="北京" cssClass="formSelect"
				...
				<tbody id="imgcontd" style="display: none;">
					<tr>
						...
						<td>
							<img src="${storeInfoDTO.imageFileFileName}"
