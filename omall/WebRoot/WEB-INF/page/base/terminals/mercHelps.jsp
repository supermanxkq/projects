		...
		<div >
			<table class="searchTable" cellpadding="0" cellspacing="0">
				<tr>
		            ...
		            <td>商户编号:</td>
					<td><input type="text" id="search_mercId" name="mercId" onkeyup = "allowEnCnNu(this)" maxlength="20" class="formInput"/></td>
					<td>商户名称:</td>
					<td><input type="text" id="search_name" name="mercName" maxlength="30" class="formInput"/></td>
