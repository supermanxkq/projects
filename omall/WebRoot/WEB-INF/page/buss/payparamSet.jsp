...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <script>
       ...
       function psUrlBlur(obj){
             ...
             var urlErrorMsg = ["Url地址不能为空!","Url地址格式不对 !"];
       ...
       function feeRateBlur(obj){
             var type = ["isNull","islowNum"];
             var feeRateEMsg = ["费率不能为空 !","费率为0-100之间的数字,如99.99!"];
       ...
       function getEle(ele){
		...
		function validatelength(obj){
		 obj.value = obj.value.substring(0, 254);
		}
...
<body>
	...
	<s:form  id="thisForm"  action="buss/payparam" method="post" onsubmit="document.getElementById('submitInput').disabled = true;" theme="simple">
		...
		<table width="100%" border="0" cellpadding="0" cellspacing="0" class="formTable">
		    <tr>
		        ...
		        <td><s:textfield name="payParamDTO.psName" id="psName" disabled="true"  maxlength="40" onblur="psNameBlur(this);" cssClass="formInput"/> <label id="psNameErrorMsg" style="display: none;"></label></td>
		   		</s:if>
		   		...
		   		<s:else>
		   		<td><s:textfield name="payParamDTO.psName" id="psName"  readonly="true"  maxlength="40" onblur="psNameBlur(this);" cssClass="formInput"/> <label id="psNameErrorMsg" style="display: none;"></label></td>
		   		</s:else>
		   	</tr>
		   	<tr>
		   		<th align="right"><span class="Color5">* </span><strong>所属支付机构：</strong></th>
		   		<s:if test="method=='checkUI'">
		        <td><s:select id="payOrgans" name="payParamDTO.payOrgId" list="#request.payOrgans"   disabled="true"  headerKey="-1" headerValue="请选择" listKey="key" listValue="value" onchange="psOrgansBlur(this);" cssClass="formSelect"/><label id="payOrgansErrorMsg" style="display: none;"></label></td>
		   		</s:if>
		   		<s:else>
			...
			<tr>
		      	...
		      	<s:if test="method=='checkUI'">
		        <td><s:textfield name="payParamDTO.psUrl"  disabled="true" onblur="psUrlBlur(this);" id="psUrl" maxlength="150" cssClass="formInput"/> <label id="psUrlErrorMsg" style="display: none;"></label></td>
		      	</s:if>
		   		<s:else>
			...
			<tr>
		      	...
		      	<s:if test="method=='checkUI'">
		        <td><s:textfield name="payParamDTO.accountNo"  onkeyup = "allowEnCnNu(this);" disabled="true" onblur="accountNoBlur(this);" id="accountNo" maxlength="50" cssClass="formInput"/> <label id="accountNoErrorMsg" style="display: none;"></label></td>
		      	</s:if>
		   		<s:else>
		 	...
		 	<tr>
		      	...
		      	<s:if test="method=='checkUI'">
		        <td><s:textfield name="payParamDTO.psPwd"  disabled="true" onblur="psPwdBlur(this);" id="psPwd" maxlength="18" cssClass="formInput"/> <label id="psPwdErrorMsg" style="display: none;"></label></td>
		        </s:if>
		   		<s:else>
		  	...
		  	<tr>
		      	...
		      	<s:if test="method=='checkUI'">
		        <td><s:textfield name="payParamDTO.secretKey"  onkeyup = "OnlyEnAndNum(this);" onblur="secretKeyBlur(this);" disabled="true" id="secretKey" maxlength="32" cssClass="formInput"/> <label id="secretKeyErrorMsg" style="display: none;"></label></td>
		        </s:if>
		   		<s:else>
		   		<td><s:textfield name="payParamDTO.secretKey"  onkeyup = "OnlyEnAndNum(this);" onblur="secretKeyBlur(this);" id="secretKey" maxlength="32" cssClass="formInput"/> <label id="secretKeyErrorMsg" style="display: none;"></label></td>
		   		</s:else>
		  	</tr>
		  	<tr>
		      	<th align="right"><span class="Color5">* </span><strong>手续费率：</strong></th>
		      	<s:if test="method=='checkUI'">
		        <td><s:textfield name="payParamDTO.feeRate"   onblur="feeRateBlur(this);"  disabled="true" onkeyup = "replaceToNumPoint(this);"  id="feeRate"  maxlength="32" cssClass="formInput"/> <label id="feeRateErrorMsg" style="display: none;"></label></td>
		         </s:if>
		   		<s:else>
		   		 <td><s:textfield name="payParamDTO.feeRate"   onblur="feeRateBlur(this);" onkeyup = "replaceToNumPoint(this);"  id="feeRate"  maxlength="32" cssClass="formInput"/> <label id="feeRateErrorMsg" style="display: none;"></label></td>
		   		</s:else>
		  	</tr>
			<tr>
		      	<th align="right"><span class="Color5">* </span><strong>支持货到付款：</strong></th>
		      	<s:if test="method=='checkUI'">
		        <td><s:radio name="payParamDTO.codSign" disabled="true" list="%{#{1:'是',0:'否'}}"  value="payParamDTO.codSign"  ></s:radio></td>
		         </s:if>
		   		<s:else>
		   		<td><s:radio name="payParamDTO.codSign" list="%{#{1:'是',0:'否'}}"  value="payParamDTO.codSign"  ></s:radio></td>
		   		</s:else>
			</tr>
			<tr>
		      	<th align="right"><span class="Color5">* </span><strong>支持在线支付：</strong></th>
		      	<s:if test="method=='checkUI'">
		        <td><s:radio name="payParamDTO.payOnlineSign" list="%{#{'1':'是','0':'否'}}"  disabled="true"  value="payParamDTO.payOnlineSign" ></s:radio><label id="settPriodErrorMsg" style="display: none;"></label></td>
				 </s:if>
		   		<s:else>
		   		<td><s:radio name="payParamDTO.payOnlineSign" list="%{#{'1':'是','0':'否'}}"   value="payParamDTO.payOnlineSign" ></s:radio><label id="settPriodErrorMsg" style="display: none;"></label></td>
		   		</s:else>
			</tr>
			<tr>
		      	<th align="right"><strong>支付方式描述：</strong></th>
		      	<s:if test="method=='checkUI'">
		      	<td><s:textarea  name="payParamDTO.descr"  id="descr" readonly="true" onkeyup="validatelength(this)"  cssClass="formTextarea" cols="80" rows="5" ></s:textarea></td>
		      	</s:if>
		   		<s:else>
		   		<td><s:textarea  name="payParamDTO.descr"   onkeyup="validatelength(this)"  cssClass="formTextarea" cols="80" rows="5" ></s:textarea></td>
		   		</s:else>
		   	</tr>
	 	</table>
