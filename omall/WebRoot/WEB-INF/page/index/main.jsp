	...
	<body >
		 <table height="100%" cellspacing="0" cellpadding="0" width="100%" border="0">
		  <tbody>
		    ...
		    <tr>
		      <td height="100%" style=" border-top:none; "><iframe style="z-index:-10;  width:100%; height:100%;" id="main" name="main"  allowTransparency="true" marginheight="0" src="<%=basePath%>system/index!right" frameborder="0" noResize></iframe></td>
		    </tr> 
		    <tr>
     ...
     <div class="hd-main clearfix" id="header" style=" position:absolute; background:#0F4A13; height:25px; width:100px; z-index:20; right:40px; top:0px">
		<div class="info" >
			<ul>
