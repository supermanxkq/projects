	...
	<input type="hidden" id="flag1"/>
		<table width="100%" border="0" cellpadding="0" cellspacing="0" class="formTable">
			<tr>
			   <th align="right" width="20%" >群组编号：</th>
		        <td width="30%">
							<s:textfield name="memGroupsDTO.groupId" id="groupId" disabled="true" maxlength="6"
							cssClass="formInput" theme="simple" />
		        </td>
		  		<th align="right" width="20%">群组名称：</th>
		        <td width="30%">
							<s:textfield name="memGroupsDTO.groupName" id="groupName" disabled="true" maxlength="6"
							cssClass="formInput" theme="simple"  />
		        </td>
			</tr>
		 	<tr >
		 	<th align="right" width="20%">创建时间：</th>
		        <td width="30%">
							<s:textfield name="memGroupsDTO.createTime" id="createTime"  disabled="true" maxlength="6"
							cssClass="formInput" theme="simple"  />
		        </td>
				<th align="right" width="20%">更新时间：</th>
		        <td width="30%">
							<s:textfield name="memGroupsDTO.updateTime" id="updateTime"  disabled="true" maxlength="6"
							cssClass="formInput" theme="simple"  />
		        </td>
		  	</tr>
		  	<tr>
		        ...
		        <td width="30%">
							<s:textfield name="memGroupsDTO.name" id="name"  disabled="true" maxlength="6"
							cssClass="formInput" theme="simple"  />
		        </td>
		        <th align="right" width="20%">创建人：</th>
		        <td width="30%">
							<s:textfield name="memGroupsDTO.userName" id="userName" disabled="true" maxlength="6"
							cssClass="formInput" theme="simple"  />
		        </td>
			</tr>
			<tr>
			   <th align="right">群组状态：</th>
				<td width="30%">	
							<s:textfield name="memGroupsDTO.status" id="status" disabled="true"  maxlength="6"
							cssClass="formInput" theme="simple"   />
               </td>  
				<th align="right">
						会员群组描述：
				...
				<td colspan="3">
					<s:textarea name="memGroupsDTO.groupDesc" id="groupDesc"
							cssClass="formTextarea read" cols="45" rows="20" readonly="true" />
				</td>
			</tr>
		</table>
		...
		<table width="96%" id="MembersTb" class="listTable" cellpadding="0"
					...
					<tr>
			            ...
			            <th width="10%"><a name="realName" >会员昵称</a></th>
