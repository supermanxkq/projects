...
<body onload="query(${messDto.page });">
	...
	<div class="search">
		<div class="Fl" style="position:relative;top:25px;">
		...
		<table class="searchTable" cellpadding="0" cellspacing="0">
			<tr>
				...
				<td>参数名称:</td>
				<td><s:textfield id="messName" name="messDto.messName" cssStyle="width:147.5px;" cssClass="formInput" maxlength="20" theme="simple"/>
				</td>
				<td>使用状态:</td>
	...
	<table width="96%" id="listTable" class="listTable" cellpadding="0" cellspacing="0" >
		<tr>
			<th width="2%">序号</th>
			<th width="8%"><a name="mfpId" class="sort">参数名称</a></th>
			<th width="5%">套餐类型</th>
			<th width="5%">条数/月</th>
			<th width="5%">费用</th>
			<th width="4%">使用状态</th>
			...
			<th width="8%"><a name="beginTime" class="sort">开始时间</a></th>
			<th width="8%"><a name="endTime" class="sort">截至时间</a></th>
			<th width="8%">操作人</th>
