...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
	...
	<script type="text/javascript">
		...
		function query(page) {
		   ...
		   ajaxData("stock/headquin!jsonPageList",params);
		}
		...
		var consoleDlg = $("#show_Detail");
		  var modSerId = $("#modSerId").val();
		  var actionUrl = "stock/headquin!sureStockIn";
		  $.ajax({
		          url:actionUrl,
	...
	<s:if test="#session.user_session.userLevel==0">
		<div class="Fl">
			<my:permission key='sy-2201-02' value='总部入库添加'>
				<input type="button" class="formButton" value="添加" onclick="go('stock/headquin!addUI')"/>
			</my:permission>
		</div>
	</s:if>
