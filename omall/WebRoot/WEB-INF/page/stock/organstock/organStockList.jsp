...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
	...
	<script type="text/javascript">
		...
		function query(page) {
		   ...
		   ajaxData("stock/orgcard!jsonPageList",params); 
		}
            ...
            if(flag == 1){
            	...
            	'取消': function() {
	             ...
	             '确认入库':function(){
				    sureStockIn();//确认入库
			        $(this).dialog('close');
			        ajaxData("stock/orgcard!jsonPageList",condition);
		          }
                }
            }
			$("#show_Detail").dialog({
		...
		function sureStockIn(){
		  ...
		  var actionUrl = "stock/orgcard!sureStockIn";
		  $.ajax({
		          url:actionUrl,
...
<body onload="query(${modStockDTO.page });">
	...
	<s:if test="#session.user_session.userLevel==0">
		<div class="Fl">
			<my:permission key='sy-2201-02' value='机构领卡添加'>
				<input type="button" class="formButton" value="添加" onclick="go('stock/orgcard!addUI')"/>
			</my:permission>
		</div>
	</s:if>
