 ...
 * @ClassName:ITrades
 * @Description:积分消费记录实体Bean
 * @date: 2014-11-11
 * @author: 毛智东
 * @version: V1.0
 */
@Entity
@Table(name = "it_trades")
public class ITrades implements Serializable {

	/**
	 * 序列化ID
	 */
	private static final long serialVersionUID = -171078584472071542L;
