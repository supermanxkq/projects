...
public class GoodsFamilyAttrRelaDaoImpl extends DaoSupport<GoodsFamilyAttrRela>
		implements GoodsFamilyAttrRelaDao {

	/**
	 * 
	 *@OverRiddenMethod：@see 
	 *                        com.paySystem.ic.dao.base.GoodsFamilyAttrRelaDao#save
	 *                        (com.paySystem.ic.web.dto.base.
	 *                        GoodsFamilyAttrRelaDTO)
	 *@MethodName:save
	 ...
	 * 
	 *@OverRiddenMethod：@see 
	 *                        com.paySystem.ic.dao.base.GoodsFamilyAttrRelaDao#deleteByFamilyId
	 *                        (java.lang.Integer)
	...
	public void deleteByFamilyId(Integer familyId) {
		Query query = this.em
				.createNativeQuery("delete from b_familyattrrela where familyId=?");
	 ...
	 * 
	 *@OverRiddenMethod：@see 
	 *                        com.paySystem.ic.dao.base.GoodsFamilyAttrRelaDao#getAssociatedFamilyId
	 *                        ()
	...
	public QueryResult<List> getAssociatedFamily(int firstPage, int pageNum,
			GoodsFamilyDTO familyDTO, LinkedHashMap<String, String> orderBy)
			throws Exception {
		...
		if (familyDTO.getFamilyName() != null
				&& !familyDTO.getFamilyName().equals("")) {
	 ...
	 * 
	 *@OverRiddenMethod：@see 
	 *                        com.paySystem.ic.dao.base.GoodsFamilyGroupRelaDao#updateStautsByFamilyId
	...
	public void updateStautsByFamilyId(Integer familyId, Integer status) {
		Query query = this.em
				.createNativeQuery("update b_familyattrrela set status=? where familyId=?");
	 ...
	 * 
	 *@OverRiddenMethod：@see 
	 *                        com.paySystem.ic.dao.base.GoodsFamilyAttrRelaDao#getFirstFamily
	 *                        ()
	...
	public GoodsFamilyDTO getFirstFamily() throws Exception {
		List<Object[]> list = em
				.createNativeQuery(
						"select familyid,familyName,status from b_GoodsFamily where parentId=0 order by familyid asc")
				.getResultList();
	 ...
	 * 
	 *@OverRiddenMethod：@see 
	 *                        com.paySystem.ic.dao.goods.TypeAttrDAO#findTypeAttrRelaList
	 *                        (int)
	...
	public List<TypeAttrDTO> findTypeAttrRelaList(int typeId) throws Exception {
		Query query = em
				.createQuery("from GoodsAttribute o where o.attrId in ( select o1.attrId from GoodsFamilyAttrRela o1 where o1.familyId="
						+ typeId + ")");
	 ...
	 * 
	 *@OverRiddenMethod：@see 
	 *                        com.paySystem.ic.dao.goods.TypeAttrDAO#queryAttrEntityList
	 *                        (int)
	...
	public List<AttrEntity> queryAttrEntityList(int attrId) throws Exception {
		Query query = em.createQuery("from AttrEntity o where o.attrId = "
				+ attrId);
	 ...
	 *@return
	 *@Author:孟凡岭
	 *@Date:2014-12-3上午09:40:26
	 */
	@SuppressWarnings("unchecked")
	public GoodsFamilyAttrRelaDTO findByFamilyId(Integer familyId) throws Exception{
		// TODO Auto-generated method stub
		String sql = "from GoodsFamilyAttrRela g where g.familyId=?1";
		List<GoodsFamilyAttrRela> list = this.em.createQuery(sql).setParameter(
				1, familyId).getResultList();
		if(list!=null){
			return (GoodsFamilyAttrRelaDTO) EntityDtoConverter.bean2Dto(list.get(0), new GoodsFamilyAttrRelaDTO());
		}
		return null;
	}
	 ...
	 *@param g
	 *@Author:孟凡岭
	 *@Date:2014-12-3上午10:41:34
	 */
	public void saveRel(GoodsFamilyAttrRela rel) {
		// TODO Auto-generated method stub
		String sql="from GoodsFamilyAttrRela g where g.familyId=?1 and g.attrId=?2";
		Query query=this.em.createQuery(sql);
		query.setParameter(1, rel.getFamilyId());
		query.setParameter(2, rel.getAttrId());
		List<GoodsFamilyAttrRela> list=query.getResultList();
		if(list.size()==0){
			this.save(rel);
		}
	}
