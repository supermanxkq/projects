...
public class GoodsFormatGroupDaoImpl extends DaoSupport<GoodsFormatGroup> implements
	 ...
	 *@author: 王少辉
	 *@Date: 2014-11-28 下午04:23:31
	 */
	public Integer saveObject(GoodsFormatGroupDTO formatGroupDTO) {
		GoodsFormatGroup formatGroup = new GoodsFormatGroup();
		BeanUtils.copyProperties(formatGroupDTO, formatGroup);
		this.save(formatGroup);
		
		return formatGroup.getFgroupId();
	}
	
	/**
	 *@Title: findByName
	 *@Description: 根据商品规格分组名称查询规格分组编号
	 *@Params: name 商品规格分组名称
	 *@Return: Integer 规格分组编号
	 *@author: 王少辉
	 *@Date: 2014-11-28 下午04:36:45
	 */
