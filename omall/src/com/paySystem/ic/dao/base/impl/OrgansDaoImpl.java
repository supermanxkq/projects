...
public class OrgansDaoImpl extends DaoSupport<Organs> implements OrgansDao {
	...
	/**
	 *@OverRiddenMethod：@see com.paySystem.ic.dao.base.OrgansDao#findById(java.lang.String)
	 *@MethodName:findById
	 *@Description:TODO
	 *@param orgId
	 *@return
	 *@Author:孟凡岭
	 *@Date:2014-12-5上午11:40:54
	 */
	@Override
	public Organs findById(String orgId) {
		// TODO Auto-generated method stub
		String sql="from Organs o where o.organId=?";
		List<Organs> list=this.em.createQuery(sql).setParameter(1, orgId).getResultList();
		if(list.size()>0){
			return list.get(0);
		}
		return null;
