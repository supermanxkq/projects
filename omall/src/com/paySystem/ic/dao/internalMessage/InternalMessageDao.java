package com.paySystem.ic.dao.internalMessage;
...
/**
 * @ProjectName:omall
 * @ClassName:InternalMessageDao
 * @Description:站内信dao
 * @date: 2014-11-19上午10:50:20
 * @author: 徐凯强
 * @version: V1.0
 */
public interface InternalMessageDao extends DAO<InternalMessage>{

	/** 常量 */
	public static final String INTERNALMESSAGEDAO = "InternalMessageDao";
