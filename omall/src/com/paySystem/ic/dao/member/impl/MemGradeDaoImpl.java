...
public class MemGradeDaoImpl extends DaoSupport<MemGrade> implements MemGradeDao {
    ...
    public MemGradeDTO getDto(MemGrade mg) {
        ...
        if (mg != null) {
            ...
            dto.setImgSrcFileName(mg.getImgSrc());
        }
        return dto;
    }
    ...
    public synchronized MemGrade saveMemGrade(MemGradeDTO memGradeDto) {
        ...
        memGradeDto.setGradeId(getGradeId());
        if (memGradeDto != null) {

            String filePath = upLoadImg(memGradeDto);
    ...
    public ReturnDTO updateMemGrade(MemGradeDTO memGradeDto) {
        ...
        if (memGrade != null) {
            ...
            if (memGradeDto.getImgSrc() != null && memGradeDto.getImgSrc().isFile()) {
                String filePath = upLoadImg(memGradeDto);
                memGrade.setImgSrc(filePath);
            }
            memGrade.setGradeId(memGradeDto.getGradeId());
    ...
    public String upLoadImg(MemGradeDTO memGradeDto) {
    	
    	
    	String filePath="";
		try {
			filePath = UploadUtil.uploadImg(memGradeDto.getImgSrc(), memGradeDto.getImgSrcFileName());
		} catch (Exception e) {
