...
public class AdvertMaserviceImpl extends DaoSupport<AdvertMa> implements
		AdvertMaService {
	@Resource
	AdvertMaDAO advertma;
	/**
	 *@OverRiddenMethod：@see 
	 *                        com.paySystem.ic.service.marketing.AdvertMaService#
	 *                        queryResult(int, int,
	...
	public QueryResult<AdvertMaDTO> queryResult(int firstindex, int maxresult,
		...
		return advertma
				.queryResult(firstindex, maxresult, advertMaDTO, orderby);
	}
	...
	public void addSave(AdvertMaDTO adverMaDTO) throws Exception{
		if (adverMaDTO != null) {
	       ...
	       String fileName = UploadUtil.uploadImg(adverMaDTO.getImageFile(),adverMaDTO.getImageFileFileName());
				/** 设置文件名 **/
				adverMaDTO.setImagePath(fileName);
			}
			adverMaDTO.setCreateTime(new Date());
			adverMaDTO.setUpdateTime(new Date());
	 ...
	 */
	public AdvertMaDTO find(Integer annountId) throws Exception {
	...
	public void updateAdvertMa(AdvertMaDTO advertMaDTO) throws Exception{
		if (advertMaDTO != null) {
			if (advertMaDTO.getImageFile() != null&& StringUtils.isNotBlank(advertMaDTO.getImageFileFileName())) {
				/** 上传文件 **/				
				String 	fileName = UploadUtil.uploadImg(advertMaDTO.getImageFile(),advertMaDTO.getImageFileFileName());		
				/** 设置文件名 **/
				advertMaDTO.setImagePath(fileName);				
			}
			advertMaDTO.setUpdateTime(new Date());
	 ...
	 *@OverRiddenMethod：@see 
	 *                        com.paySystem.ic.service.marketing.AdvertMaService#
	 *                        findAdvertMaName(java.lang.String,
	...
	public boolean findAdvertMaName(String advertMaName, String method,
		...
		if (method.equals("addSave")) {
			...
			if (list.size() > 0
					&& !list.get(0).getAdvertId().equals(advertMaId)) {
				flag = true;
			}
		}
		return flag;
	...
	/**
	 *@OverRiddenMethod：@see com.paySystem.ic.service.marketing.AdvertMaService#findAdvertMaIsUse()
	 *@MethodName:findAdvertMaIsUse
	 *@Description:查询正在使用的广告数量
	 *@return
	 *@throws Exception
	 *@Author:张军磊
	 *@Date:2014-12-11下午12:28:46
	 */
	@Override
	public List<AdvertMa> findAdvertMaIsUse() throws Exception {		
		return advertma.findAdvertMaIsUse();
	}
