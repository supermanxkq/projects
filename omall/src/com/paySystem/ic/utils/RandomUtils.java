...
public class RandomUtils {
	...
	public static String getNumber(String pattern, int length) {
		StringBuffer sbBuffer = new StringBuffer();
		if(StringUtils.isNotBlank(pattern)){
			sbBuffer.append(DateTimeTool.dateFormat(pattern, new Date()));
		}else{
			sbBuffer.append(DateTimeTool.dateFormat("yyyyMMddHHmmss", new Date()));
		}
		sbBuffer.append(RandomUtils.getRandomInt(length));
		return sbBuffer.toString();
	}
	
	public static void main(String[] args) {

		System.out.println(getRandomInt(6));
		System.out.println(RandomUtils.getNumber("", 6));
		System.out.println(RandomUtils.getNumber("", 6));
		System.out.println(RandomUtils.getNumber("yyMMdd", 2));
	}
