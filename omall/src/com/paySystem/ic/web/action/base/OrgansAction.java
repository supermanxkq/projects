...
public class OrgansAction extends BaseAction {
	...
	public String jsonPageList() throws Exception {
		...
		for(int i = 0;i <list.size();i++){
			...
			strings.add(DateTimeTool.dateFormat("yyyy-MM-dd HH:mm:ss", organs.getCreateTime()));
			String operation = "";
	...
	public String orgJsonPageList() throws Exception{
		...
		for(int i = 0;i <list.size();i++){
			...
			strings.add(Utils.getString(organs.getOrganId()));
			strings.add(Utils.getString(organs.getName()));
			strings.add(Utils.getOptionsIntegerName(OptionsValue.STATE_STATUSD, organs.getStatus()));
	...
	public String editSave() throws Exception{
		...
		if(organs!=null){
			...
			organs.setBankAccName(Utils.getString(organsDTO.getBankAccName()));
	...
	private OrgansDTO getOrganDTO(Organs organs){
		...
		organsDTO.setBankAccName(Utils.getString(organs.getBankAccName()));
